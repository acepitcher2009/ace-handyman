...
- **Provenance of the direction:**
  - **improve** — anchored to evidence in the analysis (detected colors/fonts, the screenshot-based read of what to keep vs. modernize). State _why_ each change is recommended.
